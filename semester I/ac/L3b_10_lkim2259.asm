...
adc ebx, 0
shl ebx, 21
add eax, ebx; folyamatosan epitjuk az eredmenyt fel az eax-be

mov edx, [B]
mov ebx, 0xC0000000; mivel a b-nek a legfelso 2 bitjehez hasonlitjuk, ezert egyszerubb ha igy hasonlitunk, majd kishifteljuk oket egyenkent balra
and edx, ebx
xor ecx, ecx
shl edx, 1
adc ecx, 0
...
shl edx, 7
shr edx, 13
add eax, edx; a legalso 2 bit is bekerul az eax-be
call writeBin
ret
